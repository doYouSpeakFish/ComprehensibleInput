...
Location: `src/main/java/input/comprehensible/ui/textadventure/TextAdventureViewModel.kt:34-38`

```kotlin
⚪   34 |     ) { adventureResult, selectedSentence, inputTextValue ->
🟢   35 |         when (adventureResult) {
🟡   36 |             TextAdventureResult.Error -> TextAdventureUiState.Error
🟢   37 |             TextAdventureResult.Loading -> TextAdventureUiState.Loading
🟢   38 |             is TextAdventureResult.Success -> {
```
