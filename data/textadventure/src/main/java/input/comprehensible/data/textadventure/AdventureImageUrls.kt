 ...
 * image id resolves to the light asset `"$baseUrl/adventure-images/<id>.png"`, and the backend serves
 * a dark-theme variant `"<id>-dark.png"` alongside it that the app uses when displaying in dark theme.
 */
object AdventureImageUrls {
    ...
    /**
     * The dark-theme variant of a light cover image [url]: the `"<id>-dark.png"` asset the backend
     * serves alongside the `"<id>.png"` one, formed by inserting [DARK_SUFFIX] before the extension.
     */
