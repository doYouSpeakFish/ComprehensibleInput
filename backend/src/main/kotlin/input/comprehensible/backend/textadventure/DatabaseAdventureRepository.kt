...
class DatabaseAdventureRepository(
    ...
    override fun saveAdventurePart(adventurePart: PersistedAdventurePart): String {
        transaction(database) {
            ...
            upsertAdventure(
                ...
                existingLanguageLevel = existing?.get(AdventuresTable.languageLevel),
            )
            insertMessage(
                PersistedMessageRow(
    ...
    private fun upsertAdventure(
        ...
        AdventuresTable.upsert {
            ...
            it[this.languageLevel] = adventurePart.languageLevel ?: existingLanguageLevel ?: DEFAULT_LANGUAGE_LEVEL
