...
class TextAdventuresRepository(
    ...
    fun getAdventures(userId: String?): Flow<TextAdventuresListResult> {
        if (userId == null) return flowOf(TextAdventuresListResult.Success(emptyList()))
        return localDataSource
            .getAdventureSummaries(userId)
            .map { summaries ->
    ...
    suspend fun respondToAdventure(token: String, adventureId: String, userMessage: String) {
