...
class AccountRepository(
    ...
    suspend fun requestEmailVerificationCode(email: String): Result<Unit> =
        runCatching { remoteDataSource.requestEmailVerificationCode(email) }
            .onFailure { Timber.e(it, "Failed to request email verification code") }
