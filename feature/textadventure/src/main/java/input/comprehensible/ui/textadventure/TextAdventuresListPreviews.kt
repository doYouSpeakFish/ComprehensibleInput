...
/**
 * The row mid swipe-to-delete, dragged past the threshold with the armed delete background showing.
...
fun PreviewTextAdventuresRowSwipedToDelete() {
    ComprehensibleInputTheme {
        AdventureImagePreview {
            BoxWithConstraints {
                DeleteBackground(armed = true, modifier = Modifier.matchParentSize())
                AdventureCard(
