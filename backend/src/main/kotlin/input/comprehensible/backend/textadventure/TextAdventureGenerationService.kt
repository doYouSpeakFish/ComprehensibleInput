...
class TextAdventureGenerationService(
    ...
    private suspend fun requestAdventureResponse(
        ...
        val responseResult = structuredPromptExecutor.executeResponse(
            promptName = promptName,
            systemPrompt = systemPrompt,
            userPrompt = userPrompt,
        )
        usage.record(responseResult)
...
private data class UsageCounter(
    ...
    fun record(result: StructuredPromptResult<*>) {
