...
class TextAdventureTests(private val themeMode: ThemeMode) {
    ...
    fun `text adventure can be played to completion`() = testRule.runTest {
        ...
        onTextAdventure {
            ...
            // WHEN the reader taps the shown translation "Una linterna parpadea en el muelle."
            tapOnSentence("Una linterna parpadea en el muelle.")
            awaitIdle()

            // THEN the translation is hidden and the original sentence is shown again
